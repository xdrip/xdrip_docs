...
1. [Install](/install/download.md#which-one-to-install) the [same version](/install/install#verify-which-version-is-installed) of xDrip+ you are using on the old phone.
